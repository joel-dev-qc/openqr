...
You will create a file named `prd.md` in the location provided by the user. If the user doesn't specify a location, suggest a default (e.g., `docs/prd.md`) and ask the user to confirm or provide an alternative.
...
7. **User Stories and Acceptance Criteria**:
   ...
   - Assign a unique requirement ID (e.g., OQR-001) to each user story.
