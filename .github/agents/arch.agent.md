...
Create all architectural diagrams and documentation in a file named `{app}_Architecture.md` where `{app}` is the name of the application or system being designed. For OpenQR, save to `docs/architecture/OpenQR_Architecture.md`.
...
- Create documentation in `docs/architecture/{app}_Architecture.md` format
